...
Daten zur Impfquote - leider geben die Autoren nicht an, auf welchem Stand die Zahlen sind, mit denen sie gearbeitet haben - da ihre Studie auf den 16.11. datiert ist, arbeiten wir im Folgenden mit den Daten von diesem Tag:
...
cor(c(500,2000,5000,10000,25000,50000,100000),
         c(640,600,780,800,570,650,700))^2*100

cor(c(500,2000,5000,10000,25000,50000,100000),
         c(500,570,600,650,720,780,800))^2*100
